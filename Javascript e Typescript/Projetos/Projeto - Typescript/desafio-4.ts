...
var apiKey: string | HTMLInputElement = '691cfa45a46b415b50e7ca65a5bf91b2';
let requestToken = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2OTFjZmE0NWE0NmI0MTViNTBlN2NhNjVhNWJmOTFiMiIsInN1YiI6IjYyYmRmMDc3ZWIwOTMyMDA4YzQ4Yzk2NiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.N_RrBYrDDP3zqNswSsFKE7UcWJMPbu1LmXIdOcqmAIk';
let username: string;
let password: string;
...
class HttpClient {
  static async get(params: Param): Promise<Result> {
